...
<path d="M21.1566 8.79529V14.9711L10.6711 25.4407L10.533 26.5705L21.937 28L23.8364 12.2249L21.1566 8.79529Z" fill="#0F0F10"/>
                        ...
                        <button class="car__content-btn delete-btn" data-id = "${item.id}" type="button">удалить</button>
                    </div>
                </div>
            `
            });
    ...
    fetch('https://incoavtodb.onrender.com/cars',{
        ...
        method: "POST",
            body: JSON.stringify( {
                ...
                "privod":  e.target[2].value,
                "zapas": e.target[3].value,
                "probeg":  e.target[4].value,
